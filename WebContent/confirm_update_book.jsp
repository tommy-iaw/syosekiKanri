...
<title>管理者本更新確認画面</title>
</head>
<body>
   <div class="header2">
        <h1><strong>更新確認ページ</strong></h1>
    </div>
    <div class="main2">
    	<h3 class="aka"><strong><s:property value="message" /></strong></h3>
        <form action="CompleteUpdateAction" class="first" method="post">
    ...
    <div class="footer3">
    	<a href="update_book.jsp"><input type="button" value="戻る"></a>
    </div>
</body>
</html>